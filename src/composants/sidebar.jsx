...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: "Entreprise", icon: <FaBuilding className="ft-2" />, path: "/entreprise/identity" },
    { label: "Stockage Depot", icon: <FaBoxOpen className="ft-2" />, path: "/stockage-depot/identification" },
