...
// GET BY ID
export const getVenteStatusById = (id) => api.get(`/vente-status/get/${id}`);

// UPDATE
export const updateVenteStatus = (id, data) => api.put(`/vente-status/update/${id}`, data);

// DELETE
export const deleteVenteStatus = (id) => api.delete(`/vente-status/delete/${id}`);

// SEARCH
export const searchVenteStatus = (keyword) => api.get(`/vente-status/search?keyword=${keyword}`);