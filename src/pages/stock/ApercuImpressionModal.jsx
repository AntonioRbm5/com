                ...
                <div className="apercu-content">
                    <div className="apercu-page">
                        <div className="apercu-header">
                            ...
                            <div style={{ textAlign: 'right', fontSize: '9px', marginTop: '5px' }}>
                                Période du: 010122 à 311222
                            </div>
                        </div>

                        <div className="apercu-doc-info">
                            <div>
                                <strong>Dépôt : SIEGE</strong>
                            </div>
                            <div style={{ textAlign: 'right' }}>
                                Devise de compte : FCFA
                            </div>
                        </div>
