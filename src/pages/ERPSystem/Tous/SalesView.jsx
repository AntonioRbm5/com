...
const SalesView = ({ documents, onDocumentClick }) => {
    ...
    const handleDocumentTypeSelect = (type) => {
        if (type === 'facture') {
            ...
            alert(`Type de document sélectionné: ${type}`);
        }
    };
    ...
    if (showInvoiceForm) {
        return <InvoiceForm onClose={handleCloseInvoice} />;
    }

    if (showCommandeForm) {
        return <BonCommande onClose={handleCloseCommande} />;
    }
    ...
    return (
        <>
            ...
            <div className="action-buttons">
                ...
                <button onClick={handleNewDocument} className="btn-secondary">Nouveau</button>
