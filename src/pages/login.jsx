            ...
            <div class="col-12 col-md-6 col-xl-7">
              <div class="d-flex justify-content-center text-bg-primary">
                <div class="col-12 col-xl-9">
                  <img class="img-fluid rounded mb-4" loading="lazy" src={LogosTantana} width="150" height="80" alt="Tantana Logo" />
                  <hr class="border-primary-subtle mb-4" />
                  <h2 class="h1 mb-4">TANTANA un application de Gestion comptabilité et commercial</h2>
                  <p class="lead mb-5">Ventes, Achats, Journal, Stocks, Suivi, etc...</p>
                  <div class="text-endx">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="d-flex gap-2 gap-sm-3 justify-content-centerX">
                        ...
                        <button className="btn btn-primary rounded-pill d-flex align-items-center gap-2 position-relative px-4 py-2" 
